...
public class PelangganFrame extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        PelangganAdd pgAdd = new PelangganAdd();
        pgAdd.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(barisTerpilih >= 0){
            ...
            pelanggan.setId(idInt);
            pelanggan.setNamapelanggan(model.getValueAt(barisTerpilih,1).toString());
            PelangganAdd pgAdd = new PelangganAdd(pelanggan);
            pgAdd.setVisible(true);
        } else {
